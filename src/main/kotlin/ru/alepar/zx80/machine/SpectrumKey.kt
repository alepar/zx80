 ...
 *
 * Row 0: CAPS SHIFT, Z, X, C, V (selected by clearing A8) Row 1: A, S, D, F, G (A9) Row 2: Q, W, E,
 * R, T (A10) Row 3: 1, 2, 3, 4, 5 (A11) Row 4: 0, 9, 8, 7, 6 (A12) Row 5: P, O, I, U, Y (A13) Row
 * 6: ENTER, L, K, J, H (A14) Row 7: SPACE, SYMBOL SHIFT, M, N, B (A15)
 */
