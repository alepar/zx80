...
/**
 * `RES n, (IX+d), r` — undocumented. Clear bit n of memory[IX+d], write back to memory AND copy the
 ...
 */
class ResIxdCopyback(private val idx: IndexReg, private val n: Int, private val dst: Reg) : Op {
    ...
    override fun mnemonic(operands: OperandFetcher) = "RES $n, (${idx.mnemonic}+d), ${dst.mnemonic}"
}
