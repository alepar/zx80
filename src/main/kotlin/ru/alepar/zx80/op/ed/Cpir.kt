...
/**
 * `CPIR` — block compare increment + repeat. ED B1. Loops while BC != 0 AND no match (Z not set).
 * Loop iteration: 21 T-states, PC unchanged. Exit (BC=0 or match): 16 T-states, PC += 2.
 */
object Cpir : Op {
    ...
    override fun mnemonic(operands: OperandFetcher) = "CPIR"
}
