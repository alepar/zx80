...
val downloadRom by
    tasks.registering {
        ...
        // 48K ROM. Verified live mirror returning 16384 bytes with the SHA-256 below as of
        // 2026-05-10.
        ...
        doLast {
            ...
            logger.lifecycle(
                "downloaded 48.rom (${actualSize} bytes, sha256=$actualSha) to $target"
            )
        }
    }
